    ...
    <div class="tpl-left-nav tpl-left-nav-hover">
        ...
        <div class="tpl-left-nav-list">
            <ul class="tpl-left-nav-menu">
                ...
                <li class="tpl-left-nav-item">
                    <a href="${ctx}/admin/log.html" class="nav-link tpl-left-nav-link-list active">
                        <i class="am-icon-bar-chart"></i>
                        <span>日志管理</span>
                    </a>
                </li>
...
//                    '页<span>');
    ...
    function deletefile() {
        ...
        var id = $("#fileid").html();
        $.ajax({
            url: ${ctx}'/admin/deleteMessage/' + id,
            type: 'POST',
            cache: 'false',
            async: 'false',
            dataType: 'TEXT',
    ...
    function detilecontent(obj) {
      var content=  $(obj).parent().parent().parent().find(".content").html();
