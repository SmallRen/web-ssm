                        ...
                        <div>
                            <div style="cursor: pointer;width: 100%;padding-bottom: 20px;">
                                <div>
                                    <div style="padding-bottom: 50px;">
                                        <img style="padding:10px;border-radius: 13px;width: 300px;height: 200px" class="liveimg"
                            ...
                            <div style="height: 40px;">
                                <a href="/details.html/${c.id}" style="text-decoration: none">
                                    <button style="float:right;border-width:0px;border-radius: 3px;margin-right: 10px"
                                            type="button"
